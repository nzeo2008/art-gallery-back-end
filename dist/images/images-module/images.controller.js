...
let ImagesController = class ImagesController {
    constructor(imagesService, loggerService) {
        this.imagesService = imagesService;
        this.loggerService = loggerService;
    }
    uploadImagesToEvents(body, files) {
    ...
    uploadImagesToExhibitions(body, files) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!files || files.length === 0) {
                return [];
            }
    ...
    uploadImagesToArtists(body, files) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!files || files.length === 0) {
                return [];
            }
...
ImagesController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.TYPES.ImagesService)),
